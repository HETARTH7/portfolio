...
export default function Connect() {
  ...
  return (
    <div id="connect" className="text-center font-mono">
      <h1 className="text-4xl font-black tracking-tighter pb-24">Connect</h1>
      <Link href="https://github.com/HETARTH7" target="_blank">
        <button className="bg-neutral-900 text-xl w-48 h-48 hover:text-2xl rounded-3xl mb-8">
          GitHub
        </button>
      </Link>
      ...
      <Link href="https://stackoverflow.com/users/16973267/hetarth7" target="_blank">
        <button className="bg-neutral-900 text-center text-xl w-48 h-48 hover:text-2xl rounded-3xl mb-8">
          StackOverflow
        </button>
      </Link>
